...
// function to not remove the same team pieces
            ...
            if (item.innerText == `${toggle}pawn`) {
                ...
                if(tog % 2 !== 0 && aup < 800) {
                    ...
                    if (aside > 1 && document.getElementById(`b${a + 99}`).innerText.length !== 0) {
                        document.getElementById(`b${a + 99}`).style.backgroundColor = 'greenyellow';
                    }
                }
                ...
                if(tog % 2 == 0 && aup > 100) {
                    ...
                    if (aside < 8 && document.getElementById(`b${a - 99}`).innerText.length !== 0) {
                        document.getElementById(`b${a - 99}`).style.backgroundColor = 'greenyellow';
                    }
                    if (aside > 1 && document.getElementById(`b${a - 101}`).innerText.length !== 0) {
                        document.getElementById(`b${a - 101}`).style.backgroundColor = 'greenyellow';
                    }
                }
